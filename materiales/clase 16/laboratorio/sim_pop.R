...
# Completar el objeto "rid" (real id) para que tenga la posición en la tabla 
# que corresponde a la persona que va a experimentar el próximo evento y
# "t" para que tenga el tiempo al evento
rid <- 
t <- 
