...
# Bajo este supuesto, las tasas de ocurrencia/exposición representan al riesgo 
# del evento. Es decir que el vector de tasas específicas representa la función
# de riesgo del evento en cuestión (fallecimiento  / primer hijo).

# Vamos a empezar por entender las relaciones entre las funciones de riesgo,
# riesgo acumulado y función de supervivencia.
